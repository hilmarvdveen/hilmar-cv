...
export const FitCvCard = ({ sessionId }: FitCvCardProps) => {
    ...
    return (
      <Card variant="tinted" className="mt-8">
        <div className="flex items-start gap-3">
          ...
          <div>
            <h3 className="text-subsection-title text-textMain">{t("sentTitle")}</h3>
  ...
  return (
    <Card className="mt-8">
      ...
      <form onSubmit={handleSubmit} className="mt-5 space-y-4" aria-busy={isSending}>
